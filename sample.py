...
def sample_glide_and_upscale(
    ...
    upscaler = UpscaleSR(scale=4, device=device, dtype=torch.float16 if has_cuda else torch.float32)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Sample from GLIDE and upscale with SwinIR')
