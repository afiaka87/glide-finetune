...
def random_center_crop(
    ...
    # Choose random scale
    scale = random.uniform(min_scale, 1.0)  # noqa: S311 - Pseudorandom appropriate for data augmentation
    crop_w = int(w * scale)
    crop_h = int(h * scale)
    ...
    left += random.randint(-max_dx, max_dx)  # noqa: S311 - Pseudorandom appropriate for data augmentation
    top += random.randint(-max_dy, max_dy)  # noqa: S311 - Pseudorandom appropriate for data augmentation
