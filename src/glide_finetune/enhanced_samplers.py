...
def add_enhanced_samplers_to_diffusion(diffusion_class):
    ...
    def euler_sample_loop(
        ...
        for _i, timestep_idx in enumerate(indices_iter):
            ...
            with th.no_grad():
                ...
                _extract_into_tensor(self.alphas_cumprod, t, img.shape)
        ...
        for _i, timestep_idx in enumerate(indices_iter):
            ...
            with th.no_grad():
                ...
                if order == 1 or prev_epsilon is None:
                    ...
                    msg = f"DPM-Solver order {order} not implemented"
...
def enhance_glide_diffusion(diffusion):
    ...
    add_enhanced_samplers_to_diffusion(diffusion_class)
    return diffusion
