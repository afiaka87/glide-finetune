...
class TestTF32Support:
    ...
    def test_tf32_flag_enables_tf32(self):
        ...
        if compute_capability < (8, 0):
            pytest.skip(f"GPU compute capability {compute_capability} doesn't support TF32")
...
"""],
    ...
    def test_tf32_performance_difference(self):
        ...
        try:
            ...
            print(f"FP32 time: {time_fp32:.2f}ms, TF32 time: {time_tf32:.2f}ms, speedup: {speedup:.2f}x")
