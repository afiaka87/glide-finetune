...
class TestSamplers:
    ...
    def test_plms_sampler(self, test_model_and_diffusion, test_shape, test_prompt, device, num_steps):
        """Test PLMS sampler."""
    ...
    def test_ddim_sampler(self, test_model_and_diffusion, test_shape, test_prompt, device, num_steps, eta):
        """Test DDIM sampler."""
        model, diffusion, options = test_model_and_diffusion
    ...
    @pytest.mark.parametrize("num_steps", [10, 25])
    def test_euler_sampler(self, test_model_and_diffusion, test_shape, test_prompt, device, num_steps):
        """Test Euler sampler."""
        model, diffusion, options = test_model_and_diffusion
    ...
    def test_euler_ancestral_sampler(self, test_model_and_diffusion, test_shape, test_prompt, device, num_steps, eta):
    ...
    def test_dpm_plusplus_sampler(self, test_model_and_diffusion, test_shape, test_prompt, device, num_steps, use_karras):
        """Test DPM++ 2M sampler."""
        model, diffusion, options = test_model_and_diffusion
    ...
    def test_sampler_registry(self):
        ...
        expected_samplers = ["plms", "ddim", "euler", "euler_a", "dpm++_2m", "dpm++_2m_karras"]
    ...
    def test_sampler_determinism(self, test_model_and_diffusion, test_shape, test_prompt, device, sampler_name):
...
class TestSamplersWithRealModel:
    ...
    def test_visual_quality(self, test_model_and_diffusion, device, sampler_name):
        ...
        print(f"Generated samples with {sampler_name}: shape={samples.shape}, "
