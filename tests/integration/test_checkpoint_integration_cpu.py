...
def test_checkpoint_integration_cpu():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert len(optimizer_files) == len(pt_files), "Mismatch between model and optimizer files"
        assert len(json_files) == len(pt_files), "Mismatch between model and metadata files"
