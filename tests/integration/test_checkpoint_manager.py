...
class TestCheckpointManager:
    ...
    def test_save_and_load_full_checkpoint(self, temp_checkpoint_dir, model_and_optimizer):
    ...
    def test_partial_checkpoint_missing_optimizer(self, temp_checkpoint_dir, model_and_optimizer):
