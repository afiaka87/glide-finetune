...
class TestFixedSamplers:
    ...
    def test_euler_ancestral_sampler_initialization(self, mock_diffusion, mock_model_fn):
    ...
    def test_sampler_produces_valid_output(self, sampler_name, mock_diffusion, mock_model_fn):
